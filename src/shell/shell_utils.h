...
#define invert_text_attribute() print("\033[7m");
...
#define term_clear_to_right() print("\033[0K")

/* -------------------------------------------------------------------------- */

#define term_hide_cursor() print("\033[?25l")
#define term_show_cursor() print("\033[?25h")
